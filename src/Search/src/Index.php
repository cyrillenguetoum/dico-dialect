...
use Search\Exception\InvalidFileFormatException;
use Search\Exception\OutOfRangeException;
use Search\Exception\RuntimeException;
use Search\Search\Similarity\AbstractSimilarity;
use Search\Search\QueryParser;
...
class Index implements SearchIndexInterface
{
    ...
    /**
     * Array of Search_Index_SegmentInfo objects for current version of index.
     *
     * @var array Search\Index\SegmentInfo
     */
    ...
    {
        /**
         * Search uses segments.gen file to retrieve current generation number
         *
     ...
     *
     * @throws Search\Exception\InvalidFileFormatException
     */
        ...
        for ($count = 0; $count < $segments; $count++) {
            ...
            if ($numField != (int)0xFFFFFFFF) {
                ...
                throw new RuntimeException(
                    'Separate norm files are not supported. Optimize index to use it with Search.'
                );
            }
     ...
     *
     * @param Search\Storage\Directory\Filesystem|string $directory
     * @throws Search\Exception\InvalidArgumentException
     * @throws Search\Exception\RuntimeException
     */
    ...
    /**
     * Returns an instance of Search_Index_Writer for the index
     *
     * @return Search\Index\Writer
     */
    ...
    /**
     * Returns the Search_Storage_Directory instance for this index.
     *
     ...
     * @param integer $id
     * @return boolean
     * @throws Search\Exception\OutOfRangeException	is thrown if $id is out of the range
     */
     ...
     * of Search_Search_QueryHit objects.
     * Input is a string or Search_Search_Query.
     *
     * @param Search\Search\QueryParser|string $query
    ...
    public function find($query)
    {
        if (is_string($query)) {
            ...
            throw new InvalidArgumentException('Query must be a string or Search\Search\Query object');
        }
    ...
    /**
     * Returns a Search_Document object for the document
     * number $id in this index.
     *
     * @param integer|SearchSearch\QueryHit $id
     * @return Search\Document
     * @throws Search\OutOfRangeException    is thrown if $id is out of the range
     */
    public function getDocument($id)
    {
        if ($id instanceof Search\QueryHit) {
            /* @var $id SearchSearch\QueryHit */
            $id = $id->id;
        }
     ...
     * Search_Index_DocsFilter object
     *
     * @param Search\Index\Term $term
     * @param Search\Index\DocsFilter|null $docsFilter
     ...
     *
     * @return SearchSearch\Similarity\AbstractSimilarity
     */
     ...
     *
     * @param integer|SearchSearch\QueryHit $id
     * @throws Search\Exception\OutOfRangeException
     */
     ...
     *
     * @var Search\TermStreamsPriorityQueue
     */
