...
abstract class AbstractSegmentWriter
{
     ...
     * \Search\Search\Similarity\AbstractSimilarity::encodeNorm())
     *
     * @var array
     */
     ...
     *
     * @var \Search\Storage\File\FileInterface
     */
     ...
     *
     * @param \Search\Document\Field $field
     * @return integer
     */
     ...
     * Returns actual field number
     *
     * @param \Search\Index\FieldInfo $fieldInfo
     * @return integer
     */
     ...
     *
     * @param array $storedFields array of \Search\Document\Field objects
     */
     ...
     *
     * @param \Search\Index\Term $termEntry
     ...
     *
     * @param \Search\Storage\File\FileInterface $dicFile
     * @param \Search\Index\Term $prevTerm
     * @param \Search\Index\Term $term
     * @param \Search\Index\TermInfo $prevTermInfo
     * @param \Search\Index\TermInfo $termInfo
     */
