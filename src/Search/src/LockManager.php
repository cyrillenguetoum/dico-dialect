...
use Search\Storage\Directory\DirectoryInterface as Directory;
...
class LockManager
{
     ...
     *
     * @param Search\Storage\Directory $lockDirectory
     ...
     *
     * @param Search\Storage\Directory $defaultLockDirectory
     * @return Search\Storage\File\FileInterface
     * @throws Search\Exception\RuntimeException
     */
