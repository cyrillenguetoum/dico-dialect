...
class MultiSearcher implements SearchIndexInterface
{
     ...
     * Array of Search_Interface objects
     *
     * @var array
     */
    protected $_indices;
    ...
    public function __construct($indices = array())
    {
        ...
        foreach ($this->_indices as $index) {
            if (!$index instanceof SearchIndexInterface) {
                throw new InvalidArgumentException('sub-index objects have to implement Search\Interface.');
            }
        }
    }
     ...
     *    Search_Interface  callbackFunction(Search_Document $document, array $indices);
     *
