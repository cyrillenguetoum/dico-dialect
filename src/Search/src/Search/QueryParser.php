 ...
 * @subpackage Search
 */
class QueryParser extends AbstractFSM
{
    /**
     * Parser instance
     *
     * @var \Search\Search\QueryParser
     */
     ...
     * Query lexer
     *
     * @var \Search\Search\QueryLexer
     */
    private $_lexer;

    /**
     * Tokens list
     * Array of Search_Search_QueryToken objects
     *
     * @var array
     */
    private $_tokens;
     ...
     *
     * @var \Search\Search\QueryParserContext
     */
    private $_context;
     ...
     * Default is true.
     *
     * Use {@link Search::suppressQueryParsingExceptions()},
     * {@link Search::dontSuppressQueryParsingExceptions()} and
     * {@link Search::checkQueryParsingExceptionsSuppressMode()} to operate
     * with this setting.
     *
     * @var boolean
     */
     ...
     *
     * @return \Search\Search\QueryParser
     */
