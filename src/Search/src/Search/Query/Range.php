...
use Search\Exception\OutOfBoundsException;
...
class Range extends AbstractQuery
{
     ...
     *
     * @param \Search\Index\Term|null $lowerTerm
     * @param \Search\Index\Term|null $upperTerm
     ...
     * @throws \Search\Exception\OutOfBoundsException
