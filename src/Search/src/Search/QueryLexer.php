...
use Search\AbstractFSM;
use Search\FSMAction;
use Search\Search\Exception\QueryParserException;
 ...
 * @subpackage Search
 */
class QueryLexer extends AbstractFSM
{
    ...
    public function __construct()
    {
        ...
        $lexemeModifierErrorAction    = new FSMAction($this, 'lexModifierErrException');
        $quoteWithinLexemeErrorAction = new FSMAction($this, 'quoteWithinLexemeErrException');
        $wrongNumberErrorAction       = new FSMAction($this, 'wrongNumberErrException');
        ...
        /** Actions */
        $syntaxLexemeAction    = new FSMAction($this, 'addQuerySyntaxLexeme');
        $lexemeModifierAction  = new FSMAction($this, 'addLexemeModifier');
        $addLexemeAction       = new FSMAction($this, 'addLexeme');
        $addQuotedLexemeAction = new FSMAction($this, 'addQuotedLexeme');
        $addNumberLexemeAction = new FSMAction($this, 'addNumberLexeme');
        $addLexemeCharAction   = new FSMAction($this, 'addLexemeChar');
