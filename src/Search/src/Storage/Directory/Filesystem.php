...
namespace Search\Storage\Directory;
...
class Filesystem implements DirectoryInterface
{
    ...
    /**
     * Cache for Search_Storage_File_Filesystem objects
     * Array: filename => Search_Storage_File object
     *
     * @var array
    ...
    /**
     * Returns a Search_Storage_File object for a given $filename in the directory.
     *
