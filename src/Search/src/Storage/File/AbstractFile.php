...
abstract class AbstractFile implements FileInterface
{
     ...
     *
     * @throws Search\Search\Exception\RuntimeException
     * @return integer|float
     */
    protected function _readLong32Bit()
    {
        ...
        if ($wordHigh & (int)0x80000000) {
            ...
            if ($wordHigh == (int)0xFFFFFFFF  &&  ($wordLow & (int)0x80000000)) {
                ...
                throw new Search\Exception\RuntimeException(
     ...
     *
     * @param string $str
     * @throws Search\Search\Exception\InvalidArgumentException
     */
    public function writeString($str)
    {
        ...
        if ($chars < 0) {
            throw new Search\Exception\InvalidArgumentException('Invalid UTF-8 string');
        }
